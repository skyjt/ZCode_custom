...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "aibuddy";
export const DEV_ELECTRON_APP_NAME = "AIbuddy Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.aibuddy.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 aibuddy URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 aibuddy 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".aibuddy-dev-electron-source.json");
