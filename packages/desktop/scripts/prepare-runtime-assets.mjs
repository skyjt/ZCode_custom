...
const shouldSkipRemoteAssets = process.env.AIBUDDY_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (AIBUDDY_SKIP_REMOTE_ASSETS=1)");
}
