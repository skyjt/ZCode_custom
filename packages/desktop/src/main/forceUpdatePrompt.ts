...
function buildForceUpdatePromptMessages(locale: Locale) {
  ...
  return {
    ...
    checkingMessage: "Keep this window open while AIbuddy checks for updates.",
    downloadingTitle: "Downloading update",
    downloadingVersionTitle: "Downloading update v{version}",
    downloadingMessage: "AIbuddy will install the update automatically after download.",
    readyTitle: "Update downloaded",
    readyMessage: "AIbuddy is preparing to restart and install the update.",
    installingTitle: "Installing update",
    installingMessage: "AIbuddy will restart to finish installing the update.",
    ...
    <main class="panel" role="dialog" aria-modal="true" aria-labelledby="title">
      <header class="titlebar">
        <div class="brand">
          ...
          <div class="brand-title">AIbuddy</div>
        </div>
