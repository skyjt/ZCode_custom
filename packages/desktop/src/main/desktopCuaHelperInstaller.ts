...
import { HELPER_APP_NAME } from "@aibuddy/aibuddy-cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@aibuddy/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.AIBUDDY_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
