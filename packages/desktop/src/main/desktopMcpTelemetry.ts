...
export function reportMcpTelemetryToArms(
  event: AIbuddyMcpTelemetryEvent,
...
function mapMcpTelemetryEvent(event: Exclude<AIbuddyMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<AIbuddyMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
