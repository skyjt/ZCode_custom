...
import type { ApplicationIconInfo } from "@aibuddy/shared";
...
public static class AIbuddyAumidIcon {
...
'@;
$aibuddyIconBytes=[AIbuddyAumidIcon]::Read($aibuddyArg0);
[Console]::Out.Write([Convert]::ToBase64String($aibuddyIconBytes));
`;
