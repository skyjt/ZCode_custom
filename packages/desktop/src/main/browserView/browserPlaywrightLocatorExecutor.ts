...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@aibuddy/shared";
...
const PLAYWRIGHT_WORLD_NAME = "aibuddy-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__aibuddyPlaywrightInjected";
