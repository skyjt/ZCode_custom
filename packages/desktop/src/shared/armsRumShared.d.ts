import { type AIbuddyRuntimeEnv } from "@aibuddy/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: AIbuddyRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@aibuddy/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
