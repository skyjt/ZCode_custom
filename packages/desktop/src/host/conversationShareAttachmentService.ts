import { Event as RpcEvent } from "@aibuddy/rpc";
import type { IConversationShareService, IAIbuddyAgentService } from "@aibuddy/services";
import { conversationShareConnectionScopeFactory } from "@aibuddy/services/node";
