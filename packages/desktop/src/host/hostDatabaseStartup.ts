import {
  ...
  resolveAIbuddyAgentSpawnCwd,
} from "@aibuddy/services/storage-startup";
import type { DatabaseStartupState } from "@aibuddy/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveAIbuddyAgentSpawnCwd({
