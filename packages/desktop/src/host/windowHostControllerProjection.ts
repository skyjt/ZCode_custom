...
import type { AIbuddyArchivedTaskDeletionResult } from "@aibuddy/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: AIbuddyTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | AIbuddyArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: AIbuddyTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
