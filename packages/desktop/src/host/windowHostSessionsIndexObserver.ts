...
import { AIBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE, type IAIbuddyAgentService } from "@aibuddy/services";
import {
  PROTOCOL_V4_LIMITS,
  sessionsIndexTopic,
...
> &
  Partial<Pick<IAIbuddyAgentService, "onAgentRuntimeLifecycle">>;
