...
export const HELPER_ADDON_ENV = "AIBUDDY_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "aibuddy-cua-windows-dev/v1";
...
export function isPotentialAIbuddyCuaAgentMcpServer(_server) {
  return false;
}
