...
export const BROKER_SOCKET_ENV = "AIBUDDY_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "AIBUDDY_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `aibuddy-cua-broker-${randomUUID()}.sock`);
}
