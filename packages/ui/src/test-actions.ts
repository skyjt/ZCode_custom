...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 aibuddyAgentService 拉取插件 overview */
  getPluginsOverview: IAIbuddyAgentService["getPluginsOverview"];
  /** E2E 通过真实 aibuddyAgentService 添加 marketplace */
  addPluginMarketplace: IAIbuddyAgentService["addPluginMarketplace"];
  /** E2E 通过真实 aibuddyAgentService 刷新 marketplace */
  updatePluginMarketplace: IAIbuddyAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 aibuddyAgentService 安装 marketplace plugin */
  installPlugin: IAIbuddyAgentService["installPlugin"];
  /** E2E 通过真实 aibuddyAgentService 触发插件 discover */
  listPlugins: IAIbuddyAgentService["listPlugins"];
  /** E2E 通过真实 aibuddyAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IAIbuddyAgentService["getPluginReferenceCatalog"];
}
