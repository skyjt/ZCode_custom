...
import type { AIbuddyElicitationQuestion, AIbuddyElicitationRequest } from "@aibuddy/shared";
import type { InteractionAutoResolution } from "@aibuddy/shared/aibuddy-protocol-v4";
...
interface ElicitationDialogProps {
  request: AIbuddyElicitationRequest;
...
interface NormalizedElicitationQuestion extends AIbuddyElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: AIbuddyElicitationRequest): boolean {
