...
import type { WorkspaceFileEntry, AIbuddyTaskChangeSummary, AIbuddyTaskMeta } from "@aibuddy/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = AIbuddyTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = AIbuddyTaskChangeSummary["files"][number];
...
function getTaskTitle(task: AIbuddyTaskMeta, untitledLabel: string): string {
