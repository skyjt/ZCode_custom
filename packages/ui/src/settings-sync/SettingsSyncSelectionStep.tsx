...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@aibuddy/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useAIbuddyIntl>["intl"]): string {
  switch (agent) {
    case "aibuddy":
      return intl.formatMessage({ id: "settingsSync.agent.aibuddy" });
    case "claudeCode":
