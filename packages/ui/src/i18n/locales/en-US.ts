...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like AIbuddy to show its work?",
  ...
  "occupationOnboarding.memoryDescription":
    "Let AIbuddy remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting AIbuddy",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen AIbuddy.",
  ...
  "startup.global.starting_services": "Starting AIbuddy",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "AIbuddy will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another AIbuddy or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen AIbuddy. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen AIbuddy to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen AIbuddy.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a AIbuddy restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into AIbuddy",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to AIbuddy and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to AIbuddy",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to AIbuddy",
  "login.description": "Connect your account to start using AIbuddy",
  ...
  "logout.confirm.title": "Disconnect and restart AIbuddy?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only AIbuddy Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About AIbuddy",
  ...
  "titleBar.menu.help.toggleAIbuddyStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update AIbuddy to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart AIbuddy to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the AIbuddy CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "AIbuddy checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the AIbuddy terminal font.",
  ...
  "settings.aibuddyInteractionBehavior": "Interaction behavior",
  "settings.aibuddyInteractionBehaviorDescription":
    "While AIbuddy is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.aibuddyInteractionBehavior.option.queue": "Queue",
  "settings.aibuddyInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .aibuddy/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the AIbuddy installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching AIbuddy task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by AIbuddy",
  ...
  "resourceManager.storage.diskUsage": "AIbuddy uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the AIbuddy desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "AIbuddy could not verify its Windows secure import component. Reinstall or update AIbuddy before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, AIbuddy will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by AIbuddy Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "AIbuddy provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This AIbuddy Agent cannot refresh OAuth status. Upgrade or restart AIbuddy, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to AIbuddy to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into AIbuddy",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to AIbuddy 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by AIbuddy automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in AIbuddy.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. AIbuddy uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in AIbuddy after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "AIbuddy MCP",
  ...
  "sidebar.usage.plan.mcp": "AIbuddy MCP",
  "sidebar.usage.plan.aibuddyMcp": "AIbuddy MCP",
  "sidebar.usage.plan.aibuddyMcpDescription":
    "Daily aggregate quota for AIbuddy built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into AIbuddy. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. AIbuddy follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into AIbuddy",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by AIbuddy Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend AIbuddy with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into AIbuddy and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. AIbuddy follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into AIbuddy",
  ...
  "settings.commands.description":
    "Manage AIbuddy Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.aibuddyAgent": "AIbuddy Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into AIbuddy. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. AIbuddy follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into AIbuddy",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .aibuddyignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".aibuddyignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint":
    "Save first; .aibuddyignore lives at the workspace root",
  ...
  "settingsSync.action.finish": "Start using AIbuddy",
  "settingsSync.agent.aibuddy": "AIbuddy Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current AIbuddy settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to AIbuddy",
  ...
  "onboarding.welcome.title": "Welcome to AIbuddy",
  "onboarding.welcome.start": "Start AIbuddy",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while AIbuddy imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "AIbuddy will copy {source} to {target}.\nIf the target file already exists, the AIbuddy default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask AIbuddy anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask AIbuddy anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, AIbuddy will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want AIbuddy to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart AIbuddy app and retry, or ask AIbuddy to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with AIbuddy in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for AIbuddy: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with AIbuddy in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current AIbuddy Agent session",
  ...
  "chat.error.noAvailableModel":
    "No model available. Configure an API provider, Base URL, API key and model ID.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'AIbuddy MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No AIbuddy MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "AIbuddy",
  ...
  "feedback.submit.template.section.copyErrorHeading": "AIbuddy Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while AIbuddy is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task AIbuddy can work on in the background, including the expected result and any constraints…",
  ...
  "offPeak.create.codingPlanToast":
    "Off-peak tasks require the retired account service. Use regular tasks or scheduled automations.",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "AIbuddy Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "AIbuddy Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart AIbuddy",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart AIbuddy to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified AIbuddy plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "AIbuddy will verify the Computer Use tools against the exact session when your first session starts.",
