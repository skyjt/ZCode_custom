...
import type { Locale, LocalePreference } from "@aibuddy/shared";
import { DEFAULT_LOCALE } from "@aibuddy/shared";
import type { BroadcastMessage, IBroadcastService, ISettingService } from "@aibuddy/services";
import {
...
const LOCALE_PREFERENCE_KEY = "aibuddy-locale-preference";
 ...
 */
export function AIbuddyIntlProvider({
  children,
  settingService,
  broadcastService,
  initialLocale,
...
/** 获取 intl 上下文 */
export function useAIbuddyIntl(): IntlContextValue {
  const ctx = useContext(IntlContext);
  if (!ctx) {
    throw new Error("useAIbuddyIntl 必须在 AIbuddyIntlProvider 内使用");
  }
  return ctx;
}
