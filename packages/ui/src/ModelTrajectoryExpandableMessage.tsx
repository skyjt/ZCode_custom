...
function compactTextPreview(message: AIbuddyModelTrajectoryMessage): string {
...
function firstLinePreview(message: AIbuddyModelTrajectoryMessage): string {
...
function messageClipboardText(message: AIbuddyModelTrajectoryMessage): string {
