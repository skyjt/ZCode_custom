...
import type { IUsageStatsService } from "@aibuddy/services";
import type {
  CodingPlanResetScopeRequest,
  CodingPlanResetStatusSnapshot,
  CodingPlanResetType,
  AIbuddyAccountAccess,
  AIbuddyProviderAccountAccess,
} from "@aibuddy/shared";
...
export function useCodingPlanQuotaResetUi({
  ...
  accountAccess?: AIbuddyProviderAccountAccess | AIbuddyAccountAccess | null;
  enabled?: boolean;
