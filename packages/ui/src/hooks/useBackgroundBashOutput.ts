...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@aibuddy/shared";
import { useAIbuddyAgentService } from "@/hooks/useAIbuddyAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useAIbuddyAgentService(workspacePath, remoteSessionId, workspaceIdentity);
