...
import type { AIbuddyAccountAccess, AIbuddyProviderAccountAccess } from "@aibuddy/shared";

type StableAccountAccess = AIbuddyProviderAccountAccess | AIbuddyAccountAccess;
