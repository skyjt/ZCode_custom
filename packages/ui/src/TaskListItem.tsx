...
import { isCronTask, isOffPeakTask, type AIbuddyTaskMeta } from "@aibuddy/shared";
import { TID_TASK_ARCHIVE, TID_TASK_ITEM, testId } from "@aibuddy/shared";
...
function getTaskAutomationIdentity(task: AIbuddyTaskMeta): string | undefined {
  return task.cronAutomationId ?? (task as AIbuddyTaskMeta & { automationId?: string }).automationId;
}

function areTaskListItemTaskFieldsEqual(left: AIbuddyTaskMeta, right: AIbuddyTaskMeta) {
  if (left === right) {
    return true;
  }
