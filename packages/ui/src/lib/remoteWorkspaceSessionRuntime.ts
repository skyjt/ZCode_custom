import type { AIbuddyTaskRuntimeStatus } from "@aibuddy/shared";
import { getWorkspaceDisplayedTaskState } from "@/store/aibuddySessionStore.js";
import type { AIbuddySessionStoreState, WorkspaceAIbuddyUIState } from "@/store/aibuddySessionStore.js";
...
interface MarkRemoteWorkspaceRunningTasksFailedParams {
  ...
  getWorkspaceState: AIbuddySessionStoreState["getWorkspaceState"];
  setTaskRuntimeState: AIbuddySessionStoreState["setTaskRuntimeState"];
  reason: string;
}

function isRunningRuntimeStatus(status: AIbuddyTaskRuntimeStatus): boolean {
...
function collectRemoteWorkspaceRunningTaskIds(workspaceState: WorkspaceAIbuddyUIState): string[] {
