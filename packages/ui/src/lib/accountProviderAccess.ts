...
import { type AIbuddyProviderAccountAccess, aibuddyProviderAccountAccessSchema } from "@aibuddy/shared";

interface EntitledAccountProviderAccess {
  readonly providerId: string;
  readonly access: AIbuddyProviderAccountAccess;
...
export function resolveEntitledAccountProviderAccess(
  ...
  const parsed = aibuddyProviderAccountAccessSchema.safeParse(provider.effectiveConfig.access);
