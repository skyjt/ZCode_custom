...
function hasOwnTaskMetaField<T extends keyof AIbuddyTaskMeta>(task: AIbuddyTaskMeta, key: T) {
...
function resolveMergedTaskTitle(preferredTask: AIbuddyTaskMeta, fallbackTask: AIbuddyTaskMeta): string {
...
export function mergeTaskWithOptimisticMeta(
  ...
  optimisticTask: AIbuddyTaskMeta,
): AIbuddyTaskMeta {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<AIbuddyTaskMeta | null | undefined>
): AIbuddyTaskMeta | undefined {
  let merged: AIbuddyTaskMeta | undefined;
