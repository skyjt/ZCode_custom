import type { ArmsCustomEventPayload } from "@aibuddy/shared";
...
type ArmsCustomEventDebugWindow = Window & {
  __aibuddyArmsCustomEventsE2E?: ArmsCustomEventE2EEntry[];
};
...
export function recordArmsCustomEventForE2E(
  ...
  const buffer = (host.__aibuddyArmsCustomEventsE2E ??= []);
  buffer.push({
    ...payload,
