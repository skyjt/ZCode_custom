...
import { createUuid, type RemoteTarget, type RemoteWorkspaceSessionEntry } from "@aibuddy/shared";
import {
                ...
                {currentStep === "directory" ? (
                  <div data-testid={TID_SSH_SUCCESS} className="h-full">
                    <RemoteConnectionDirectoryStep
                      ...
                      remoteAIbuddyAgentService={directoryBrowserServices?.aibuddyAgentService ?? null}
