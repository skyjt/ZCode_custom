import type { AIbuddyPluginComponentKind } from "@aibuddy/shared";
...
export interface PluginComponentDisplayGroup {
  kind: AIbuddyPluginComponentKind;
...
const COMPONENT_BADGE_STYLES: Record<AIbuddyPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<AIbuddyPluginComponentKind, string> = {
