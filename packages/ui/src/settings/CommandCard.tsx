...
import type { UserCommand, AIbuddyCommand } from "@aibuddy/shared";
import { isPluginCommand, isUserCommand } from "@aibuddy/shared";
...
export function isEditableUserCommand(command: AIbuddyCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "aibuddy";
}

interface CommandCardProps {
  command: AIbuddyCommand;
  onEdit?: (command: AIbuddyCommand) => void;
  onToggle?: (command: AIbuddyCommand, enabled: boolean) => void;
  isOperating?: boolean;
