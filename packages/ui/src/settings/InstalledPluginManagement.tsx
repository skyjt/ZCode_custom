...
import type { AIbuddyPluginDiagnostic, AIbuddyPluginInfo } from "@aibuddy/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: AIbuddyPluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<AIbuddyPluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<AIbuddyPluginInfo["hookDetails"]>[number]): string {
