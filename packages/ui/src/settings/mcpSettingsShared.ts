import type { McpServerConfig, AIbuddyMcpServer } from "@aibuddy/shared";

export const MCP_SECTIONS = ["aibuddyagentmcp"] as const;
...
export function serverToForm(server: AIbuddyMcpServer): FormState {
...
// 与 shared 层 convertToAIbuddyAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
