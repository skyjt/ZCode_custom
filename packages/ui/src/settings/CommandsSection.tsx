...
import type { CommandConfig, UserCommand, AIbuddyCommand } from "@aibuddy/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: AIbuddyCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: AIbuddyCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? AIBUDDY_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
