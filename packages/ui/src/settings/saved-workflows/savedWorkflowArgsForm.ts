...
import type { AIbuddySavedWorkflowArgType, AIbuddySavedWorkflowArgsDeclaration } from "@aibuddy/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: AIbuddySavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: AIbuddySavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: AIbuddySavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: AIbuddySavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: AIbuddySavedWorkflowArgsDeclaration = {};
