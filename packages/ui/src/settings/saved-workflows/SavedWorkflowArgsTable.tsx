...
import type { AIbuddySavedWorkflowArgType } from "@aibuddy/shared";
...
const ARG_TYPES: readonly AIbuddySavedWorkflowArgType[] = ["string", "number", "boolean", "json"];
          ...
          >
            <div className={cn("grid items-center gap-3", columns)}>
              ...
              <Select
                value={row.type}
                onValueChange={(value) =>
                  onChange(row.key, { type: value as AIbuddySavedWorkflowArgType })
                }
              >
