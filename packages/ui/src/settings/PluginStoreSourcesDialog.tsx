...
import type { AIbuddyPluginMarketplaceSummary } from "@aibuddy/shared";
...
function isRemovableMarketplace(marketplace: AIbuddyPluginMarketplaceSummary): boolean {
...
function PluginStoreSourceRefreshFailure({
  ...
  failure: NonNullable<AIbuddyPluginMarketplaceSummary["refreshFailure"]>;
}) {
