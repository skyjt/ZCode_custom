...
import type {
  ...
  AIbuddyImportedSessionSkippedItem,
} from "@aibuddy/shared";
...
function ImportIssuesList({
  ...
  title: string;
  items: AIbuddyImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: AIbuddyImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: AIbuddyImportSessionsResult | null;
  isImporting: boolean;
