...
function McpServerItem({
  ...
  server: AIbuddyMcpServer;
  onEdit: (server: AIbuddyMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: AIbuddyMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "aibuddy";
