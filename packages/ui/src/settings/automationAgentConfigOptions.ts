import type { AIbuddyConfigOption, AIbuddyProvider } from "@aibuddy/shared";
...
export function buildAutomationModeOption(currentValue: string): AIbuddyConfigOption {
  return {
    id: "mode",
    name: "Mode",
    category: "mode",
...
export function resolveAutomationModelItem(
  ...
  // workspace runtime 也可能返回 aibuddy-openai-compatible/model 这类包装值，provider 对不上时
...
export function buildAutomationThoughtLevelOption(
  runtimeOption: AIbuddyConfigOption | undefined,
  currentValue: string,
