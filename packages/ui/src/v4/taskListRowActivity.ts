...
const TASK_LIST_ROW_ACTIVITY_FIELD = "__aibuddySessionActivity" as const;
...
export type TaskListMetaWithActivity = AIbuddyTaskMeta & {
  [TASK_LIST_ROW_ACTIVITY_FIELD]: TaskListRowActivity;
};

export function attachTaskListRowActivity<T extends AIbuddyTaskMeta>(
  task: T,
...
export function getTaskListRowActivity(task: AIbuddyTaskMeta): TaskListRowActivity | null {
...
function isTaskListRowRunning(task: AIbuddyTaskMeta): boolean {
 ...
 */
export function isTaskListRowActive(task: AIbuddyTaskMeta): boolean {
...
export function mergeTaskListMembershipFields(
  activityTask: AIbuddyTaskMeta,
  membershipTask: AIbuddyTaskMeta,
): AIbuddyTaskMeta {
