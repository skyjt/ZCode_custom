...
//
// 旧草稿面（aibuddySessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@aibuddy/shared";
...
const STORAGE_KEY_PREFIX = "aibuddy-v4-composer-drafts:v1:";
