...
import { useToolbarConfigOptions } from "@/hooks/useAIbuddyConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const thoughtOption = useMemo<AIbuddyConfigOption | null>(() => {
...
import { isApiKeyAccess } from "@aibuddy/provider";
