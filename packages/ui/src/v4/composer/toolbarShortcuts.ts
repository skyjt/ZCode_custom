...
import type { ShortcutCommandId, AIbuddyConfigOption } from "@aibuddy/shared";
import {
...
function getChatToolbarShortcutKey(
  category: AIbuddyConfigOption["category"],
...
export function getNextConfigSelectValue(
  option: Pick<AIbuddyConfigOption, "type" | "currentValue" | "options">,
): string | null {
...
interface ToolbarShortcutState {
  ...
  modelOption?: AIbuddyConfigOption;
  modeOption?: AIbuddyConfigOption;
  thoughtOption?: AIbuddyConfigOption;
}
