...
function toRetryStatus(apiRetry: ApiRetryState): AIbuddyApiRetryStatus {
...
function TurnChatLoadingSlot({
  ...
  return (
    <div data-aibuddy-chat-loading-slot="true" className="min-h-5">
      {visibleRetryStatus ? (
...
function ConversationTurnGroupImpl({
  ...
  const assistantCodeCommentCards = useMemo(
    () =>
      ...
      // 卡片与 aibuddy-file-citation 的预览卡片保持一致：流式期间只投影正文，
