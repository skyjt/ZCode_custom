...
import type { V4ConversationFileRewindPreviewResult } from "@aibuddy/shared/aibuddy-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useAIbuddyIntl>["intl"]) {
