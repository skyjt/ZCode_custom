...
import { TID_APP_HEADER } from "@aibuddy/shared";
...
import type { ComposerMentionPrefill } from "@/store/aibuddySessionStoreTypes.js";
...
const WORKSPACE_SIDEBAR_WIDTH_STORAGE_KEY = "aibuddy:workspace-shell:sidebar-width-px";
...
export const WorkspaceShellLayout = memo(function WorkspaceShellLayoutComponent({
  ...
  usePaneSessionPersistence({
    ...
    draftFocusVersion: workspaceShellAIbuddyState.draftFocusVersion,
  ...
  return (
    <DesktopWindowFrame
      title={`AIbuddy / ${getPathLeaf(workspaceAbsPath)}`}
      showHeader
      isDesktop={isDesktop}
                    ...
                    {shouldRenderWorkspaceHeader ? (
                      ...
                      >
                        <WorkspaceHeader
                          ...
                          workspaceHeaderState={workspaceShellAIbuddyState}
                          gitSummary={gitState.summary}
