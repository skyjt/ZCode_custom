...
interface SkillStoreState {
  ...
  initialize: (
    ...
    providerOrSkillsService: AIbuddyProvider | ISkillsService,
  ...
  setEnabled: (
    skillId: string,
    providerOrEnabled: AIbuddyProvider | boolean,
...
export const useSkillStore = create<SkillStoreState>((set, get) => ({
  ...
  async initialize(
    ...
    const provider = normalizeAgentProviderToAIbuddyAgent(
      hasProvider ? providerOrSkillsService : AIBUDDY_AGENT_PROVIDER,
    );
