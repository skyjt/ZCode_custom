import type { McpServerStatus, AIbuddyMcpServer, AIbuddyMcpServerStatusSnapshot } from "@aibuddy/shared";
...
function mapRuntimeStatusToUi(snapshot: AIbuddyMcpServerStatusSnapshot): MappedMcpServerStatus {
