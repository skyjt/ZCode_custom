...
const MCP_CONFIG_KEY = "aibuddy-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "aibuddy-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  aibuddyagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "aibuddyagentmcp" && directorySource && directorySource !== "aibuddy"
...
export function buildServerList(
  ...
  existingServers: AIbuddyMcpServer[],
): AIbuddyMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: AIbuddyMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: AIbuddyMcpServer["file"],
    location?: AIbuddyMcpServer["location"],
  ): AIbuddyMcpServer {
  ...
  const servers: AIbuddyMcpServer[] = [];
...
export function getServerPriority(server: AIbuddyMcpServer): number {
