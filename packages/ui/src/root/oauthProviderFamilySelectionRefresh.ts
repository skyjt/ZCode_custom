...
import type { AccountProviderState } from "@aibuddy/provider";
import type {
  OAuthProviderId,
...
async function refreshAccountProviderAccesses(params: {
  ...
  accesses: ReadonlyMap<string, AIbuddyProviderAccountAccess | AIbuddyAccountAccess>;
  ...
  try {
    ...
    const accesses = new Map(
      params.providerIds.flatMap((providerId) => {
        ...
        const query: AIbuddyProviderAccountAccess | AIbuddyAccountAccess =
