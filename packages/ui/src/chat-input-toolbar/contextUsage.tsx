...
type ContextUsageBreakdownSource = AIbuddyContextUsageBreakdownItem["source"];
...
function buildContextUsageBreakdownSegments(
  breakdown: readonly AIbuddyContextUsageBreakdownItem[] | undefined,
...
export function getRenderableTaskUsage<T extends { used: number; size: number }>(
  ...
  // AIbuddy Protocol 迁移后会单独补齐真实 contextUsed/contextWindow。
...
export function getContextCompressionCommand(_provider: AIbuddyProvider): string {
  return "/compact";
}
