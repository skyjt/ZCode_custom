...
import type { ApplicationIconRequest } from "@aibuddy/shared";
import { useAIbuddyIntl } from "@/i18n/IntlProvider.js";
import { isAIbuddyCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_aibuddy_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isAIbuddyCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useAIbuddyIntl>["intl"];
