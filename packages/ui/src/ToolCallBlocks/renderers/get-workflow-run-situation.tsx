 ...
 *
 * 两条纪律与模型面
 * （apps/aibuddy-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）一字不差：
...
import type { ToolCallGetWorkflowRunDisplay } from "@aibuddy/shared/aibuddy-protocol-v4";
...
type FormatMessage = ReturnType<typeof useAIbuddyIntl>["intl"]["formatMessage"];
