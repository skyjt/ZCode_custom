...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@aibuddy/shared";
import type { AIbuddyAutomationScheduleRule } from "@aibuddy/shared";
...
function isScheduleRule(value: unknown): value is AIbuddyAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as AIbuddyAutomationScheduleRule)
    : undefined;
