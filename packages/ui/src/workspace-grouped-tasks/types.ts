import type { AIbuddyTaskGroupColor } from "@aibuddy/services";
...
const TASK_GROUP_COLOR_CLASS: Record<AIbuddyTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<AIbuddyTaskGroupColor, string> = {
