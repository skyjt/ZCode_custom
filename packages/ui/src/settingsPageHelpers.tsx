...
export type { Locale, LocalePreference } from "@aibuddy/shared";
...
const AIBUDDY_INTERACTION_BEHAVIOR_OPTIONS: readonly AIbuddyInteractionBehavior[] = ["queue", "guide"];
...
export function GeneralSectionContent({
  ...
  onAIbuddyInteractionBehaviorChange: (behavior: AIbuddyInteractionBehavior) => Promise<void>;
  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsGroupCard>
        <SettingsRow
          label={intl.formatMessage({ id: "settings.aibuddyInteractionBehavior" })}
          description={intl.formatMessage({
            id: "settings.aibuddyInteractionBehaviorDescription",
          })}
          control={
            <Select
              value={aibuddyInteractionBehavior}
              onValueChange={(value) => {
                void onAIbuddyInteractionBehaviorChange(value as AIbuddyInteractionBehavior);
              }}
            >
              <SelectTrigger size="lg" className="w-[260px] min-w-0 justify-between">
                <SelectValue />
              ...
              <SelectContent>
                {AIBUDDY_INTERACTION_BEHAVIOR_OPTIONS.map((behavior) => (
                  <SelectItem key={behavior} value={behavior}>
                    {intl.formatMessage({
                      id: `settings.aibuddyInteractionBehavior.option.${behavior}`,
                    })}
                  </SelectItem>
                ))}
              </SelectContent>
