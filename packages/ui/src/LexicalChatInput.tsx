...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __aibuddyLexicalInputE2E?: typeof bridge }).__aibuddyLexicalInputE2E === bridge
      ) {
        delete (input as { __aibuddyLexicalInputE2E?: typeof bridge }).__aibuddyLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__aibuddyLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
