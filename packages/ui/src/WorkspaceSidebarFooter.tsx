import type { Locale, UserInfo } from "@aibuddy/shared";
import { memo, useCallback, useEffect, useState } from "react";
import { DesktopCommandIds, TID_TASK_SETTINGS_BUTTON } from "@aibuddy/shared";
...
export const WorkspaceSidebarFooter = memo(function WorkspaceSidebarFooterComponent({
  ...
  const profileBadge = "AIbuddy";
  const profileContent = (
    <>
      <Settings className="size-4 shrink-0" aria-hidden="true" />
      <span className="min-w-0 truncate text-ui-base font-semibold">{profileBadge}</span>
    </>
  );
