...
export type IntlShape = ReturnType<typeof useAIbuddyIntl>["intl"];
...
function SourceTitle({ record, intl }: { record: AIbuddyModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<AIbuddyModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(callSource: NonNullable<AIbuddyModelTrajectoryRecord["callSource"]>): string {
...
function ResponseBlock({
  ...
  response: NonNullable<AIbuddyModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
