...
const APP_CA_CERT_FILE = "aibuddy-network-ca.pem";
const APP_CA_KEY_FILE = "aibuddy-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "AIbuddy Network CA" },
    { name: "organizationName", value: "AIbuddy" },
  ];
