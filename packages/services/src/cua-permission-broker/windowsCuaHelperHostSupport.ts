...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@aibuddy/aibuddy-cua/broker/server";
...
/**
 * Parse a `aibuddy-cua-windows-dev/v1` control message from the helper child.
 *
