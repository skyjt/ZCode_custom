import { resolveWorkspaceKey, type AIbuddyComputerUseOperationEvent } from "@aibuddy/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: AIbuddyComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: AIbuddyComputerUseOperationEvent,
  ): void {
