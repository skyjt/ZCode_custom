...
export class AIbuddyStorageStartupGate {
  private current?: AIbuddyStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<AIbuddyStorageStartupState>();
  ...
  get snapshot(): AIbuddyStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = aibuddyStorageStartupStateSchema.safeParse(input);
