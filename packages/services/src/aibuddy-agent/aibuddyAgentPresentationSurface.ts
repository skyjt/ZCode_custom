import type { ServiceAuthorityMode } from "@aibuddy/shared";

export type AIbuddyAgentPresentationSurface = "desktop";

interface AIbuddyAgentPresentationHostFacts {
...
export function resolveAIbuddyAgentPresentationSurface(
  facts: AIbuddyAgentPresentationHostFacts,
): AIbuddyAgentPresentationSurface | undefined {
