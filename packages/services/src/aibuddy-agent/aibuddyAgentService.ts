import { requestPluginReferenceCatalog } from "#src/aibuddy-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@aibuddy/shared";
/* oxlint-disable eslint(max-lines) -- AIbuddy Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
import { randomUUID } from "node:crypto";
import { ensureIndependentPlanSupport } from "./independentPlanSupport.js";
import { mkdirSync } from "node:fs";
import { join } from "node:path";
import { Emitter } from "@aibuddy/rpc";
...
import { completeNewModelSelection } from "@aibuddy/provider";
import type { OffPeakClientConfig } from "#src/coding-plan-subscription/codingPlanSubscription.js";
import {
  AIBUDDY_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  AIBUDDY_AGENT_PROVIDER,
  AIBUDDY_AGENT_PROVIDER_NOT_READY_CODE,
  AIBUDDY_AGENT_PROVIDER_NOT_READY_REASON,
  AIBUDDY_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  AIBUDDY_PROTOCOL_NAME,
  AIBUDDY_PROTOCOL_VERSION,
  aibuddyMcpListResultSchema,
  aibuddyPermissionRequestParamsSchema,
  aibuddyBrowserListParamsSchema,
  aibuddyBrowserExecuteParamsSchema,
  aibuddyPluginsConfigureResultSchema,
  aibuddyPluginsInstallResultSchema,
  aibuddyPluginsListResultSchema,
  aibuddyPluginsMarketplaceMutationResultSchema,
  aibuddyPluginsOverviewResultSchema,
  aibuddyProcessChildProcessesResultSchema,
  type AIbuddyProcessChildProcess,
  aibuddySkillsReferenceCatalogResultSchema,
  aibuddyWorkflowsDeleteResultSchema,
  aibuddyWorkflowsGetResultSchema,
  aibuddyWorkflowsListResultSchema,
  aibuddyWorkflowsMoveResultSchema,
  aibuddyWorkflowsRunsResultSchema,
  aibuddyWorkflowsUpdateMetaResultSchema,
  aibuddyPluginsResolveSuggestedReferenceResultSchema,
  aibuddyPluginOperationProgressNotificationSchema,
  aibuddyPluginsRestoreBuiltinResultSchema,
  aibuddyPluginsSetEnabledResultSchema,
  aibuddyPluginsCancelOperationResultSchema,
  aibuddyPluginsUninstallResultSchema,
  aibuddyPluginsValidateResultSchema,
  aibuddyPluginsDescribeResultSchema,
  aibuddyAutomationCheckTaskBindingParamsSchema,
  aibuddyAutomationCreateParamsSchema,
  aibuddyAutomationDeleteParamsSchema,
  aibuddyAutomationListParamsSchema,
  aibuddyAutomationUpdateParamsSchema,
  aibuddyOffPeakCreateParamsSchema,
  aibuddyOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  aibuddyComputerUseOperationEventSchema,
  aibuddyProviderRuntimeHeadersCancelledSchema,
  aibuddyProviderRuntimeHeadersRequestParamsSchema,
  aibuddyProviderTestModelConnectivityResultSchema,
  aibuddyOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  aibuddyProtocolEmptyResultSchema,
  aibuddyProtocolMethods,
  aibuddyProtocolNotifications,
  aibuddyMcpTelemetryEventSchema,
  aibuddyMcpResourceSamplesSchema,
  aibuddyToolExecResourceSchema,
  aibuddyProcessResourceSampleSchema,
  aibuddySessionCloseResultSchema,
  aibuddySessionCompactResultSchema,
  aibuddySessionEventsResultSchema,
  aibuddySessionGoalResultSchema,
  aibuddySessionListResultSchema,
  aibuddySessionSubagentsResultSchema,
  aibuddySessionMessagesResultSchema,
  aibuddySessionEventSchema,
  aibuddySessionSendResultSchema,
  aibuddySessionRequestRuntimePreferencesParamsSchema,
  aibuddySessionRuntimePreferencesResultSchema,
  aibuddySessionStateSnapshotSchema,
  aibuddySessionSubscribeResultSchema,
  aibuddyStateUpdatedNotificationSchema,
  aibuddyUserInputRequestParamsSchema,
  aibuddyWorkspacePresentationSchema,
  aibuddyWorkspaceCancelGenerateTextResultSchema,
  aibuddyWorkspaceGenerateTextResultSchema,
  aibuddyWorkspaceHookTrustGrantResultSchema,
  aibuddyWorkspaceUpdateInteractionPreferencesResultSchema,
  aibuddyWorkspaceUpdateModelIoPreferencesResultSchema,
  aibuddyProviderUpdateAccountConfigResultSchema,
  type AIbuddySessionStateSnapshot,
  type AIbuddyAutomation,
  type AIbuddyAutomationRun,
  aibuddyWorkspaceUpdateOffPeakToolPolicyResultSchema,
  aibuddyWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  type DynamicWorkflowClientConfig,
  type AgentLaneResourceSample,
  type ProcessResourceCliLane,
  type AIbuddyMcpTelemetryEvent,
  type AIbuddyMcpResourceSample,
  type AIbuddyToolExecResource,
  type AIbuddyPluginOperationProgressNotification,
...
} from "#src/aibuddy-agent/automationToolPolicy.js";
import { AIBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./aibuddyAgent.js";
import type {
  AIbuddyProtocolRequestId,
  ModelSelection,
  AIbuddyProviderRuntimeHeadersRequestParams,
  AIbuddySessionEvent,
  AIbuddySessionRuntimePreferencesScope,
  AIbuddySavedWorkflowScope,
...
import type {
  ...
  AIbuddyAgentBackgroundBashOutputParams,
  AIbuddyAgentAppRuntimePreferences,
  AIbuddyAgentRuntimeLifecycleEvent,
  AIbuddyAgentAddPluginMarketplaceParams,
  AIbuddyAgentAppUsageParams,
  AIbuddyAgentCancelPluginOperationParams,
  AIbuddyAgentCompactParams,
  AIbuddyAgentConfigurePluginParams,
  AIbuddyAgentResetPluginConfigParams,
  AIbuddyAgentCreateSessionParams,
  AIbuddyAgentInstallPluginParams,
  AIbuddyAgentGenerateWorkspaceTextParams,
  AIbuddyAgentTestModelConnectivityParams,
  AIbuddyAgentGoalParams,
  AIbuddyAgentGrantWorkspaceHookTrustParams,
  AIbuddyAgentInitializeResult,
  AIbuddyAgentListSessionsParams,
  AIbuddyAgentListSessionSubagentsParams,
  AIbuddyAgentReadWorkspacePresentationParams,
  AIbuddyAgentReadSessionEventsParams,
  AIbuddyAgentReadSessionMessagesParams,
  AIbuddyAgentReadSessionParams,
  AIbuddyAgentRemovePluginMarketplaceParams,
  AIbuddyAgentRespondSessionRuntimePreferencesParams,
  AIbuddyAgentResumeSessionParams,
  AIbuddyAgentSendPromptParams,
  AIbuddyAgentServiceEvent,
  AIbuddyAgentSessionSubscribeParams,
  AIbuddyAgentSessionTarget,
  AIbuddyAgentSessionRuntimePreferencesRequest,
  AIbuddyAgentTaskTokenUsageParams,
  AIbuddyAgentSetModeParams,
  AIbuddyAgentSetModelParams,
  AIbuddyAgentSetPluginEnabledParams,
  AIbuddyAgentSetThoughtLevelParams,
  ...
  AIbuddyAgentSavedWorkflowTarget,
  ...
  AIbuddyAgentCuaPermissionObservation,
  ...
  AIbuddyAgentAttachmentReadParams,
  AIbuddyAgentConversationAttachmentReadParams,
  AIbuddyAgentConversationAttachmentStatParams,
  AIbuddyAgentAttachmentPreviewSourceParams,
  AIbuddyAgentAttachmentTerminalParams,
  AIbuddyAgentConversationCommandParams,
  AIbuddyAgentCommandsQueryParams,
  AIbuddyAgentConversationFileChangesParams,
  AIbuddyAgentConversationFileRewindPreviewParams,
  AIbuddyAgentConversationRowsRangeParams,
  AIbuddyAgentConversationPlansParams,
  AIbuddyAgentConversationWorkflowRunEventsParams,
  AIbuddyAgentConversationWorkflowRunArtifactDataParams,
  AIbuddyAgentConversationWorkflowRunArtifactReadParams,
  AIbuddyAgentConversationWorkflowRunArtifactsParams,
  AIbuddyAgentConversationWorkflowRunNodeResultParams,
  AIbuddyAgentConversationWorkflowRunWorkspaceParams,
  AIbuddyAgentConversationWorkflowRunsParams,
  AIbuddyAgentConversationResyncParams,
  AIbuddyAgentConversationSubscribeParams,
  AIbuddyAgentConversationUnsubscribeParams,
  AIbuddyAgentConnectionFlowParams,
  AIbuddyAgentSessionsIndexSubscribeParams,
  AIbuddyAgentWorkspaceConfigSubscribeParams,
} from "./aibuddyAgent.js";
import {
  ...
  utf8JsonByteLength,
  AIBUDDY_ATTACHMENT_FAULT_CODES,
  AIbuddyAttachmentFaultError,
  type CommandAck,
...
import {
  readTrustedAIbuddyAgentV4Connection,
  readTrustedAIbuddyAgentV4UnsubscribeRoute,
} from "./aibuddyAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/aibuddy-agent/aibuddySessionEventCoalescer.js";
...
import { AIbuddyAgentMcpStatusModeUnsupportedError } from "#src/aibuddy-agent/aibuddyAgentErrors.js";
import { AIbuddyAgentProcessManager } from "./aibuddyAgentProcessManager.js";
import type { AIbuddyAgentProcessManagerOptions } from "./aibuddyAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  AIbuddyProtocolRequestTimeoutError,
  type AIbuddyProtocolClient,
} from "./aibuddyProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./aibuddyAgentBrowserAmbientContext.js";
import {
...
const logger = createServiceLogger("aibuddy-agent-service");
...
interface PendingPermissionRequest {
  client: AIbuddyProtocolClient;
  protocolRequestId: AIbuddyProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: AIbuddyProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: AIbuddyAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "AIbuddy agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: AIbuddyAgentWorkspaceTarget): AIbuddyWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: AIbuddyAgentSavedWorkflowTarget,
): params is AIbuddyAgentWorkspaceTarget & { scope?: AIbuddySavedWorkflowScope } {
  return typeof (params as Partial<AIbuddyAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: AIbuddyAgentSavedWorkflowTarget): {
  scope?: AIbuddySavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".aibuddy", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the AIbuddy Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.aibuddy/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when aibuddy-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__aibuddy-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof AIbuddyProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `AIbuddy Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: AIbuddyAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: AIbuddyAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: AIbuddyAgentSendPromptParams,
...
function buildSessionCompactParams(params: AIbuddyAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${AIBUDDY_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: AIbuddyAgentSessionTarget): string {
...
function permissionRequestKey(params: AIbuddyAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: AIbuddyAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: AIbuddyAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface AIbuddyAgentProviderReadinessSnapshot {
...
): AIbuddyAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: AIbuddyAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: AIbuddyAgentWorkspaceTarget): Error & {
  code: typeof AIBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("AIbuddy Agent runtime is not running.") as Error & {
    code: typeof AIBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = AIBUDDY_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateAIbuddyAgentServiceOptions extends Omit<
  AIbuddyAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: AIbuddySessionRuntimePreferencesScope,
  ) => Promise<AIbuddySessionRuntimePreferencesResult>;
...
function toProtocolAutomation(automation: AIbuddyAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<AIbuddyProtocolClient, "respondError">,
  request: { id: AIbuddyProtocolRequestId; method: string },
  workspace: AIbuddyAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createAIbuddyAgentService(
  options?: CreateAIbuddyAgentServiceOptions,
): IAIbuddyAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new AIbuddyAgentProcessManager(options);
  ...
  const pluginProcessManager = new AIbuddyAgentProcessManager({
  ...
  const mcpStatusProcessManager = new AIbuddyAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<AIbuddyAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<AIbuddyAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<AIbuddyToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<AIbuddyMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<AIbuddyMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<AIbuddyPluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<AIbuddyAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<AIbuddyProtocolClient>();
  const clientDisposables = new WeakMap<AIbuddyProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: AIbuddyAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<AIbuddyProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<AIbuddyProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: AIbuddyProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "AIbuddy provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "AIbuddy provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "aibuddy_agent.runtime_preferences.host_response_timeout",
      module: "services.aibuddy_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: AIBUDDY_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          aibuddyProtocolMethods.providerUpdateAccountConfig,
          {
        ...
        logger.info(undefined, "account provider config 已交付到 AIbuddy agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: AIbuddyProtocolClient;
    preferences: AIbuddyAgentAppRuntimePreferences;
    workspace: AIbuddyAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          aibuddyProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            aibuddyProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: AIbuddyAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 AIbuddy agent", {
  ...
  function getSessionEmitter(params: AIbuddyAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<AIbuddyAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<AIbuddyPluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: AIbuddyAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: AIbuddyAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: AIbuddyAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: AIbuddyAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function resolveV4Connection(params: unknown, fallbackConnectionId: string = v4ConnectionId) {
    return (
      readTrustedAIbuddyAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: AIbuddyAgentConversationUnsubscribeParams | AIbuddyAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedAIbuddyAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: AIbuddyAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: AIbuddyAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function emitSessionEvent(
    workspace: AIbuddyAgentWorkspaceTarget,
    sessionId: string,
    event: AIbuddyAgentServiceEvent,
  ): void {
  ...
  function handleStateUpdated(
    workspace: AIbuddyAgentWorkspaceTarget,
    notification: AIbuddyStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === aibuddyProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = aibuddyProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === aibuddyProtocolNotifications.processResourceSample) {
          const parsed = aibuddyProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 AIbuddy CLI 资源样本", {
        ...
        if (message.method === aibuddyProtocolNotifications.toolExecResource) {
          const parsed = aibuddyToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === aibuddyProtocolNotifications.mcpResourceSamples) {
          const parsed = aibuddyMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === aibuddyProtocolNotifications.mcpTelemetry) {
          const parsed = aibuddyMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 AIbuddy CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === aibuddyProtocolNotifications.pluginOperationProgress) {
          const parsed = aibuddyPluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 AIbuddy Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === aibuddyProtocolMethods.computerUseOperationEvent) {
          const parsed = aibuddyComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 AIbuddy Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = aibuddySessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 AIbuddy Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = aibuddyStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === aibuddyProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = aibuddySessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: AIbuddySessionRuntimePreferencesResult;
              try {
                preferences = aibuddySessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: AIbuddyAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "aibuddy_agent.runtime_preferences.host_request_dispatched",
            module: "services.aibuddy_agent",
            requestId,
        ...
        if (request.method === aibuddyProtocolMethods.interactionRequestPermission) {
          const parsed = aibuddyPermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === aibuddyProtocolMethods.interactionRequestUserInput) {
          const parsed = aibuddyUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = aibuddyProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 AIbuddy provider runtime headers 请求", {
        ...
        if (request.method === aibuddyProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = aibuddyOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.interactionBrowserList) {
          const parsed = aibuddyBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.interactionBrowserExecute) {
          const parsed = aibuddyBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.automationCreate) {
          const parsed = aibuddyAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.offPeakCreate) {
          const parsed = aibuddyOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.offPeakList) {
          const parsed = aibuddyOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.automationList) {
          const parsed = aibuddyAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.automationCheckTaskBinding) {
          const parsed = aibuddyAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.automationUpdate) {
          const parsed = aibuddyAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === aibuddyProtocolMethods.automationDelete) {
          const parsed = aibuddyAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported AIbuddy Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: AIbuddyAgentSessionTarget,
  ...
  function getSessionTraceId(target: AIbuddyAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof AIBUDDY_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof AIBUDDY_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = AIBUDDY_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: AIBUDDY_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof AIBUDDY_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === AIBUDDY_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    AIbuddyAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 AIbuddy Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: AIbuddyAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          aibuddyProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          aibuddyProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          aibuddyWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 AIbuddy agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: AIbuddyAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，AIbuddy agent 保持只读"
            : "provider/model 尚未就绪，AIbuddy agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 AIbuddy agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<AIbuddyProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.aibuddy/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: AIbuddyAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: AIbuddyAgentSavedWorkflowTarget,
  ): Promise<{ client: AIbuddyProtocolClient; workspace: AIbuddyWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<AIbuddyProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: AIbuddyAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: AIbuddyAgentWorkspaceTarget): Promise<AIbuddyAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 AIbuddy agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "AIbuddy agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: AIBUDDY_PROTOCOL_NAME,
          protocolVersion: AIBUDDY_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "AIbuddy agent 等待 provider/model 就绪" : "AIbuddy agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: AIBUDDY_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: AIbuddyAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: AIbuddyAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: AIbuddyAgentWorkspaceTarget) {
    ...
    async createSession(params: AIbuddyAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 AIbuddy Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          aibuddyProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "AIbuddy Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "AIbuddy Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "AIbuddy Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "AIbuddy Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          aibuddyProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "AIbuddy Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: AIbuddyAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 AIbuddy Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          aibuddyProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "AIbuddy Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "AIbuddy Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "AIbuddy Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "AIbuddy Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: AIbuddyAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        aibuddyProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: AIbuddyAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        aibuddyProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: AIbuddyAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: AIbuddyAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: AIbuddyAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        aibuddyProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: AIbuddyAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        aibuddyProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        aibuddyProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: AIbuddyAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        aibuddyProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: AIbuddyAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 AIbuddy Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: AIbuddyWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              aibuddyProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              aibuddyWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("AIbuddy Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "AIbuddy Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "AIbuddy Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: AIbuddyAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: AIbuddyAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new AIbuddyAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, aibuddyProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: AIbuddyAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          aibuddyProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, aibuddyProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: AIbuddyAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: AIbuddyAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        aibuddyProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: AIbuddyAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        aibuddyProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        aibuddyWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: AIbuddyAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        aibuddyProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        aibuddyWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: AIbuddyAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        aibuddyProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        aibuddyWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: AIbuddyAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        aibuddyProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        aibuddyWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: AIbuddyAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        aibuddyProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: AIbuddyAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        aibuddyProtocolMethods.workflowsMove,
        { workspace: buildWorkspaceRef(params), name: params.name },
        aibuddyWorkflowsMoveResultSchema,
      );
    },

    async resolveSuggestedPluginReference(params: AIbuddyAgentResolveSuggestedPluginReferenceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: AIbuddyProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              aibuddyProtocolMethods.processChildProcesses,
              {},
              aibuddyProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: AIbuddyAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: AIbuddyAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: AIbuddyAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: AIbuddyAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: AIbuddyAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: AIbuddyAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        aibuddyPluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: AIbuddyAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: AIbuddyAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: AIbuddyAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: AIbuddyAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: AIbuddyAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: AIbuddyAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: AIbuddyAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: AIbuddyAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        aibuddyProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: AIbuddyAgentWorkspaceTarget) {
    ...
    async createAutomation(params: AIbuddyAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as AIbuddyTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: AIbuddyAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as AIbuddyTaskMode | undefined),
    ...
    async deleteAutomation(params: AIbuddyAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: AIbuddyAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: AIbuddyAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: AIbuddyAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: AIbuddyAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: AIbuddyAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: AIbuddyAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 AIbuddy Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            aibuddyProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            aibuddyWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          aibuddyProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: AIbuddyAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        aibuddyProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: AIbuddyAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: AIbuddyAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "AIbuddy Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          aibuddyProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          aibuddySessionSendResultSchema,
        );
        logger.info(logTraceId, "AIbuddy Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "AIbuddy Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "AIbuddy Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: AIbuddyAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "AIbuddy Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          aibuddyProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "AIbuddy Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "AIbuddy Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: AIbuddyAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 AIbuddy Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          aibuddyProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "AIbuddy Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "AIbuddy Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: AIbuddyAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        aibuddyProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: AIbuddyAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 AIbuddy Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          aibuddyProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "AIbuddy Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "AIbuddy Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: AIbuddyAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        aibuddyProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: AIbuddyAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        aibuddyProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "aibuddy_agent.runtime_preferences.response_without_pending",
          module: "services.aibuddy_agent",
          requestId: params.requestId,
        });
        throw new Error(`AIbuddy session runtime preferences request not found: ${params.requestId}`);
      }
      const responseContext = {
        event: "aibuddy_agent.runtime_preferences.host_response_received",
        module: "services.aibuddy_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: AIbuddyAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: AIbuddyAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: AIbuddyAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              aibuddyProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("aibuddy-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: AIbuddyAgentConnectionFlowParams) {
      const trusted = readTrustedAIbuddyAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: AIbuddyAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。AIbuddy Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: AIbuddyAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: AIbuddyAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: AIbuddyAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedAIbuddyAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // AIbuddy Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: AIbuddyAgentCommandsQueryParams) {
      if (!readTrustedAIbuddyAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: AIbuddyAgentAttachmentBeginParams) {
      const trusted = readTrustedAIbuddyAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: AIbuddyAgentAttachmentChunkParams) {
      const trusted = readTrustedAIbuddyAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: AIbuddyAgentAttachmentTerminalParams) {
      const trusted = readTrustedAIbuddyAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: AIbuddyAgentAttachmentTerminalParams) {
      const trusted = readTrustedAIbuddyAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: AIbuddyAgentAttachmentReadParams) {
      if (!readTrustedAIbuddyAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: AIbuddyAgentConversationAttachmentReadParams) {
      if (!readTrustedAIbuddyAgentV4Connection(params)) {
        throw new AIbuddyAttachmentFaultError(
          AIBUDDY_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: AIbuddyAgentConversationAttachmentStatParams) {
      if (!readTrustedAIbuddyAgentV4Connection(params)) {
        throw new AIbuddyAttachmentFaultError(
          AIBUDDY_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: AIbuddyAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedAIbuddyAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: AIbuddyAgentConversationRowsRangeParams) {
      const trusted = readTrustedAIbuddyAgentV4Connection(params);
    ...
    async conversationPlansV4(params: AIbuddyAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: AIbuddyAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: AIbuddyAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: AIbuddyAgentBackgroundBashOutputParams) {
      if (!readTrustedAIbuddyAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: AIbuddyAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: AIbuddyAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: AIbuddyAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: AIbuddyAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: AIbuddyAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: AIbuddyAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: AIbuddyAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: AIbuddyAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: AIbuddyAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: AIbuddyAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: AIbuddyAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: AIbuddyAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: AIbuddyAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: AIbuddyAgentRuntimeLifecycleEvent) => void) {
