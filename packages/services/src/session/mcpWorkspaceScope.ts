...
import type { AIbuddyAgentMcpServer } from "@aibuddy/shared";
...
function isFilesystemServer(
  server: AIbuddyAgentMcpServer,
): server is Extract<AIbuddyAgentMcpServer, { command: string }> {
  return (
    "command" in server &&
...
export function appendWorkspaceToFilesystemMcpServers(
  mcpServers: AIbuddyAgentMcpServer[] | undefined,
  workspacePath: string,
): AIbuddyAgentMcpServer[] | undefined {
