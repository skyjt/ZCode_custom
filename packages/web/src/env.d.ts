declare module "*.css";
declare module "@aibuddy/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_AIBUDDY_BASE_URL?: string;
  readonly VITE_AIBUDDY_ENDPOINT_ORIGIN?: string;
  readonly VITE_AIBUDDY_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
