export type BuiltinAIbuddySlashCommandHelpEntry = {
...
export const BUILTIN_AIBUDDY_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinAIbuddySlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.aibuddy/AGENTS.md.",
      ],
      name: "init",
