...
export type CommandAgentSource = "aibuddyAgent";
...
export type AIbuddyCommand = UserCommand | PluginCommand;

export function isUserCommand(command: AIbuddyCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: AIbuddyCommand): command is PluginCommand {
