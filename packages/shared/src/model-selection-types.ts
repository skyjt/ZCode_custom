export const AIBUDDY_AGENT_PROVIDER_NOT_READY_CODE = "AIBUDDY_AGENT_PROVIDER_NOT_READY" as const;
export const AIBUDDY_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
