...
export const AIBUDDY_FILE_LOCK_TIMEOUT_ERROR_CODE = "AIBUDDY_FILE_LOCK_TIMEOUT" as const;
...
export function isAIbuddyFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === AIBUDDY_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
