import { z } from "zod";
import { aibuddySyntheticUserMessageSourceSchema } from "../aibuddy-protocol-legacy-types.js";
...
const turnStartedFactSchema = z
  .object({
    ...
    inputSource: aibuddySyntheticUserMessageSourceSchema.optional(),
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "aibuddy", "bundled", "plugin", "remote"]).optional(),
...
type TurnStartedConversationTelemetryFact = Extract<
  ...
  { kind: "turn.started" }
> &
  import("../aibuddy-task-types-core.js").AIbuddyBackgroundTurnAttribution;
