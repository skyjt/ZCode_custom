import type { AIbuddyPlanStep } from "./aibuddy-task-types-core.js";
...
function normalizePlanStatus(value: unknown): AIbuddyPlanStep["status"] | null {
...
function parsePlanStep(value: unknown, index: number): AIbuddyPlanStep | null {
...
function extractPlanStepsFromValue(value: unknown): AIbuddyPlanStep[] | null {
  ...
  const steps = collection
    ...
    .filter((step): step is AIbuddyPlanStep => step !== null);
