...
export const desktopMenuMessageIds = {
  ...
  helpToggleAIbuddyStdioTap: "titleBar.menu.help.toggleAIbuddyStdioTap",
  helpAIbuddyEndpoint: "titleBar.menu.help.aibuddyEndpoint",
  helpAIbuddyEndpointProduction: "titleBar.menu.help.aibuddyEndpoint.production",
  helpAIbuddyEndpointTest: "titleBar.menu.help.aibuddyEndpoint.test",
  helpAIbuddyEndpointCustom: "titleBar.menu.help.aibuddyEndpoint.custom",
  helpAIbuddyEndpointReset: "titleBar.menu.help.aibuddyEndpoint.reset",
  ...
  trayOpenAIbuddy: "tray.menu.openAIbuddy",
...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "titleBar.menu.help.aibuddyEndpoint": "AIbuddy Endpoint",
    "titleBar.menu.help.aibuddyEndpoint.production": "Production（默认）",
    "titleBar.menu.help.aibuddyEndpoint.test": "Test",
    "titleBar.menu.help.aibuddyEndpoint.custom": "自定义...",
    "titleBar.menu.help.aibuddyEndpoint.reset": "恢复默认",
    ...
    "tray.tooltip": "AIbuddy",
    "tray.menu.openAIbuddy": "打开 AIbuddy",
    "tray.menu.quit": "退出",
  },
  "en-US": {
    ...
    "titleBar.menu.help.aibuddyEndpoint": "AIbuddy Endpoint",
    "titleBar.menu.help.aibuddyEndpoint.production": "Production (default)",
    "titleBar.menu.help.aibuddyEndpoint.test": "Test",
    "titleBar.menu.help.aibuddyEndpoint.custom": "Custom...",
    "titleBar.menu.help.aibuddyEndpoint.reset": "Reset to default",
    ...
    "tray.tooltip": "AIbuddy",
    "tray.menu.openAIbuddy": "Open AIbuddy",
    "tray.menu.quit": "Quit",
  },
};
