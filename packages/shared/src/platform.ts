...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "aibuddy-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "aibuddy-media";
...
export interface AIbuddyStdioTapDevState {
  enabled: boolean;
  visible: boolean;
  logDir: string;
  statePath: string;
...
export const DesktopCommandIds = {
  ...
  ToggleAIbuddyStdioTapDevProxy: "toggleAIbuddyStdioTapDevProxy",
  SetAIbuddyEndpointProduction: "setAIbuddyEndpointProduction",
  SetAIbuddyEndpointTest: "setAIbuddyEndpointTest",
  SetAIbuddyEndpointCustom: "setAIbuddyEndpointCustom",
  ResetAIbuddyEndpoint: "resetAIbuddyEndpoint",
...
export interface IPlatformService {
  ...
  /** 打开 AIbuddy Computer Use 的完整权限引导。Desktop only。 */
  ...
  /** 注册 `aibuddy://share/import?code=...` 导入意图。 */
  ...
  /** 导出日志：打包 ~/.aibuddy/v2 及外部 agent 日志为 zip 并在系统文件浏览器中显示 */
