...
import { AIBUDDY_ENV } from "./env.js";
import { buildBigModelCodingPlanTeamManageUrl } from "./aibuddyEndpoint.js";
...
export const MODEL_PROVIDER_FAMILY_SPECS = [
  ...
  },
  {
    ...
    teamCodingPlanManageUrl: buildBigModelCodingPlanTeamManageUrl({ AIBUDDY_ENV }),
  },
