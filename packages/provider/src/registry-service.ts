...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnAIbuddyBuiltinRevision !== config.aibuddyBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          aibuddyBuiltinProviders: config.aibuddyBuiltinProviders,
          aibuddyBuiltinProviderTemplates: config.aibuddyBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          aibuddyBuiltinModelRules: config.aibuddyBuiltinModelRules,
