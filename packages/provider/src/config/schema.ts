import { z } from "zod";
import { modelConfigDataSchema } from "@aibuddy/shared/model-config";
...
export function parseAIbuddyBuiltinProviderConfigMap(input: unknown): ProviderConfigMap {
...
export function parseAIbuddyBuiltinProviderConfigRules(input: unknown): {
...
export function parseAIbuddyBuiltinModelConfigRules(input: unknown): ModelConfigRules {
