...
import type { EnvInfo } from "@aibuddy/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are AIbuddy Explore, a file search and codebase research specialist for AIbuddy CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
