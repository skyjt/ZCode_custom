...
import { RESPOND_TO_COORDINATOR_TOOL_NAME } from "@aibuddy/contracts";
import type { SubagentRunOptions } from "@aibuddy/contracts";
import {
  defaultScheduler,
  PermissionService,
    ...
    runExploreAgent: async (request, options) => {
      ...
      const childRuntime = new AgentRuntime(
        request.sessionId,
        {
          ...
          agentName: `aibuddy-${request.agentType}`,
