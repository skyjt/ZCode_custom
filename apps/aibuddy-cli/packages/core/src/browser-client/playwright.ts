...
} from "@aibuddy/contracts/browser-control";
...
const locatorDetails = Symbol("aibuddy.playwright.locatorDetails");
const setObjectWrapper = Symbol("aibuddy.playwright.setObjectWrapper");
