import type { ModelUsageSummary, TodoItem, TurnId } from "@aibuddy/contracts";
...
export function TuiApp({
  ...
  const initialCopy = getAIbuddyCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getAIbuddyCopy(locale), [locale]);
