...
import { SessionEventType, type SessionEvent } from "@aibuddy/contracts";
import type {
  AIbuddySessionSubagentsResult,
  AIbuddySessionRunningSubagent,
...
export type SubagentItem = AIbuddySessionRunningSubagent | AIbuddySessionEndedSubagent;
const EMPTY_DIRECTORY: AIbuddySessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
