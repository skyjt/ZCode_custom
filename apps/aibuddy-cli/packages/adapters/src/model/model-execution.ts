...
import type { RegistryProviderConfig } from "@aibuddy/provider";
import { withOpenRouterAttributionHeaders } from "@aibuddy/shared";
...
/**
 * 模型请求出口：官方 Coding Plan 端点经 AIbuddy 平台网关发送（做套餐权益校验等平台侧处理），
...
export function readProviderBusinessFailureFromBody(body: unknown):
  ...
  const providerCode =
    ...
    // 二次包装后的外层 code 是 AIbuddy 自己的 PROVIDER_BUSINESS_ERROR，
