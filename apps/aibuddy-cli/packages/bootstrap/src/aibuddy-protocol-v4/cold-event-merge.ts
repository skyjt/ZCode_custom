...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@aibuddy/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@aibuddy/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@aibuddy/contracts").MessageId;
      keptMessageIDs?: import("@aibuddy/contracts").MessageId[];
      targetMessageID?: import("@aibuddy/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@aibuddy/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@aibuddy/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@aibuddy/contracts").SessionId;
