...
import { type TurnBackgroundAttribution, type TurnInputIntentMetadata } from "@aibuddy/contracts";
import type { TurnAttachment } from "@aibuddy/core";
import type { SendInputOptions, SendInputResult } from "../../app/types.js";
import { runWithSessionResidencyFinalization } from "../../aibuddy-protocol/session-residency.js";
