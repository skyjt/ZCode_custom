...
// 1. URI ref（aibuddy-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
import type { TurnAttachment } from "@aibuddy/core";
...
async function mapAttachmentRef(app: AIbuddyApp, ref: AttachmentRef): Promise<TurnAttachment> {
