import type { PermissionOptionsPolicy, PermissionUpdate } from "@aibuddy/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type AIbuddyPermissionOption } from "@aibuddy/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 aibuddyPermissionUpdateSchema 是 strict，会话语义由
