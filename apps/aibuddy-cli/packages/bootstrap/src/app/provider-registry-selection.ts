import { ModelErrorCode, ModelProtocolError } from "@aibuddy/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): AIbuddyModelOption {
