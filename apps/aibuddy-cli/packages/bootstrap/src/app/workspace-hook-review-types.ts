...
import type { WorkspaceHookRuntimeAdmissionPort, WorkspaceHookTrustCoordinator } from "@aibuddy/core";
import type { WorkspaceHookReviewRequestPayload } from "@aibuddy/shared/aibuddy-protocol-v4";
