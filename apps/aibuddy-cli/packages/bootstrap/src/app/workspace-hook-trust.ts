import { createDefaultFileWorkspaceHookTrustStore } from "@aibuddy/adapters/storage";
import {
...
import { SessionEventType } from "@aibuddy/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@aibuddy/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.aibuddy/security。 */
  homeDir?: string;
