...
import { BUILTIN_PROVIDER_TEMPLATE_IDS } from "@aibuddy/shared";
import { getDefaultConfigPath } from "@aibuddy/adapters/config";
import {
...
function importLegacyCliPersonalProviderConfig(
  ...
  // 通用 AIbuddyConfigFileSchema 刻意把旧 provider 留在 passthrough unknown，
