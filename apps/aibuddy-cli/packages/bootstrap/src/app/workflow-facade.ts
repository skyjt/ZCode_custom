...
import { createNodeExecutionAdapter } from "@aibuddy/adapters/exec";
...
} from "@aibuddy/adapters/workflow";
import {
  AgentRuntime,
...
import type { PrepareUserExecutionBoundary, AIbuddyAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "aibuddy-expert" : "aibuddy-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "aibuddy-expert" : "aibuddy-workflow",
