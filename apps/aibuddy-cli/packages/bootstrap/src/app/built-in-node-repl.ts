import type { McpServerConfig, PluginLoadOutcome } from "@aibuddy/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { AIBUDDY_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { AIBUDDY_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
