...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@aibuddy/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@aibuddy/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@aibuddy/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（AIbuddy Protocol session/create 或 CLI
