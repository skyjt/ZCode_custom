...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@aibuddy/contracts";
 ...
 *
 *   AIbuddyApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
