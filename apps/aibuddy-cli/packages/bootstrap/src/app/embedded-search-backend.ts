import type { EmbeddedSearchBackend } from "@aibuddy/contracts";
import { getRuntimeToolRuntime } from "@aibuddy/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "AIBUDDY_EMBEDDED_SEARCH_COMMAND";
