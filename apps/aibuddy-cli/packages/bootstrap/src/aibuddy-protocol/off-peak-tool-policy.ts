import { aibuddyWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@aibuddy/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(aibuddyWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
