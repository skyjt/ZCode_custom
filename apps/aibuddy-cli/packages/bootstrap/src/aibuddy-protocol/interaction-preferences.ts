import { aibuddyWorkspaceUpdateInteractionPreferencesParamsSchema } from "@aibuddy/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(aibuddyWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
