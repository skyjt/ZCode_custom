import {
  aibuddyProviderUpdateAccountConfigParamsSchema,
  type AIbuddyProviderUpdateAccountConfigResult,
} from "@aibuddy/shared";
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<AIbuddyProviderUpdateAccountConfigResult> {
  const envelope = parseParams(aibuddyProviderUpdateAccountConfigParamsSchema, params);
