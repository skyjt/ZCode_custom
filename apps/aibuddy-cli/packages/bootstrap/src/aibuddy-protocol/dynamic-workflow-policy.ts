import { aibuddyWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@aibuddy/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(aibuddyWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
