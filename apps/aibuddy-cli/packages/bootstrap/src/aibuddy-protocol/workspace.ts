import { parseRemoteWorkspaceIdentity, type AIbuddyWorkspaceRef } from "@aibuddy/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): AIbuddyWorkspaceRef {
