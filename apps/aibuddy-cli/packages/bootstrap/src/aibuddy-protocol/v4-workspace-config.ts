...
import { getAIbuddyAgentModeSelectOptions, normalizeAvailableAIbuddyMode } from "@aibuddy/shared";
import type { AIbuddySessionSettingsState, AIbuddySlashCommand } from "@aibuddy/shared";
import type { WorkspaceConfigState } from "@aibuddy/shared/aibuddy-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpAIbuddyAgent 的注释）。
