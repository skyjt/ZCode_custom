...
import type { SupportedLocale, UiLocale } from "@aibuddy/i18n";
import type { ModelSelection, AIbuddyModelOption } from "@aibuddy/shared";
import type {
...
export type CommandCenterModelOption = AIbuddyModelOption;
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@aibuddy/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@aibuddy/tui").TuiReadSubagentTranscript;
