import { formatJson } from "@aibuddy/core";
import type { GlobalOptions, JsonValue, RunContext } from "@aibuddy/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly AIbuddyAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly AIbuddyMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetAIbuddyPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetAIbuddyPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: AIbuddyAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: AIbuddyInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: AIbuddyMarketplaceSummaryData) {
  return {
    id: marketplace.id,
