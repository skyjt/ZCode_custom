...
- IAB tabs persist for the lifetime of the current AIbuddy process. Turn end, session end, an omitted finalize call,
...
- AIbuddy does not restore these tabs after the AIbuddy process exits.
